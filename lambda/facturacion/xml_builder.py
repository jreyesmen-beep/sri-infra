...
def construir_factura(datos: dict) -> str:
    ...
    for impuesto in datos["impuestos"]:
        ...
        _texto(ti, "codigoPorcentaje", impuesto["tarifa"])   # 2=12%, 0=0%
    ...
    for item in datos["items"]:
        ...
        for imp in item["impuestos"]:
            ...
            _texto(impuesto, "codigo",           imp["codigo"])
            _texto(impuesto, "codigoPorcentaje", imp["tarifa"])
            _texto(impuesto, "tarifa",           imp["porcentaje"])
