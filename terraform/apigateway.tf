...
# OPTIONS para /facturas/{claveAcceso}
resource "aws_api_gateway_method" "options_factura_detalle" {
  rest_api_id   = aws_api_gateway_rest_api.sri.id
  resource_id   = aws_api_gateway_resource.factura_detalle.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "options_factura_detalle" {
  rest_api_id = aws_api_gateway_rest_api.sri.id
  resource_id = aws_api_gateway_resource.factura_detalle.id
  http_method = aws_api_gateway_method.options_factura_detalle.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "options_factura_detalle_200" {
  rest_api_id = aws_api_gateway_rest_api.sri.id
  resource_id = aws_api_gateway_resource.factura_detalle.id
  http_method = aws_api_gateway_method.options_factura_detalle.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "options_factura_detalle" {
  rest_api_id = aws_api_gateway_rest_api.sri.id
  resource_id = aws_api_gateway_resource.factura_detalle.id
  http_method = aws_api_gateway_method.options_factura_detalle.http_method
  status_code = "200"
...
# CORS para respuestas de error 4XX
...
# CORS para respuestas de error 5XX
